...
function preload(){
  ...
  backgroundImg = loadImage("track 1.jpg");
  shipImg = loadImage("bike-removebg-preview.png");
  bulletImg = loadImage("bullet image.png");
  
  
  ship1Img = loadImage("blast image.png");
  ship2Img = loadImage("blast image.png");
  ship3Img = loadImage("blast image.png");
  ship4Img = loadImage("blast image.png");
